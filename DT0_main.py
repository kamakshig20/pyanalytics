...
#%% Classification Tree - Predict if the Currency is FAKE or not depending upon features, 0 - not fake, 1- fake 
...
import os
os.listdir('H:/analytics/projects/pyanalytics') #change the folder to see what are the file in folder
#dataset
...
X_train.shape
X_test.shape
X_test.shape[0]/data.shape[0] #to know % of test share - shape gives list of two values 
...
#visualise 
# Import Libraries, import data, Splitting data in DV,IV, 
...
X2
y2
y2.mean() #avg petrol consumption
...
ypred2 #petrol consumption for test data 
len(ypred2)
