...
list1 = [1,2,3,4,5,'a','Kamakshi',"Gupta",True]  #list type of object with data
...
list3 = [65,35,244,5564,235,554,323,6565]
#reversing list 
list3.reverse() #reversed list stored in list3
list3
list3[::-1] #slicing is used here list[start:end:step] printed in reverse order
list4 = list(reversed(list3)) #print in reverse
list4
list3.sort()
list3
list2 = ['f','c','d','e','f']
...
for i in list1:    print('Kamakshi ', i + 6)
